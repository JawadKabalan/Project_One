                ...
                if($_SESSION != null){
                    if($_SESSION['Loged'] = true){
                     ...
                     while($row =mysqli_fetch_row( $result ) ){
                        ...
                        echo"$row2[0]    <a href='shoppingcart.php?deleteID={$row[$i]}'>Cancel</a><br>";

                     }
                    
                    }
                     echo"<a href='pay.php?Pay={$_SESSION['ID']}'>PAY</a>";
                    }
                }else{
                    echo"<p style='font-size:40px;text-align:center'>You must log in first</p>";
                }
