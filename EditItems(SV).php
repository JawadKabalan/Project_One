...
<div class="ex11">
    ...
    while($row = mysqli_fetch_row( $result ) and $row2 = mysqli_fetch_row( $result2 )){
        ...
        echo "<table><tr><td> $row[$i]</td><td><a href='EditItems.php?deleteID={$row2[$i]}'>ta bort</a></td><td><a href='ItemUpdate(SV).php?itemid=$row2[$i]'>uppdatering</a></td></tr></table></form>";
        }
}
    mysqli_close( $database );
