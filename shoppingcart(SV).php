                ...
                if($_SESSION != null){
                    if($_SESSION['Loged'] = true){
                     ...
                     while($row =mysqli_fetch_row( $result ) ){
                        ...
                        echo"$row2[0]    <a href='shoppingcart.php?deleteID={$row[$i]}'>Avbryt</a><br>";

                     }
                    
                    }
                     echo"<a href='pay(SV).php?Pay={$_SESSION['ID']}'>BETALA</a>";
                    }
                }else{
                    echo"<p style='font-size:40px;text-align:center'>Du måste logga in först</p>";
                }
